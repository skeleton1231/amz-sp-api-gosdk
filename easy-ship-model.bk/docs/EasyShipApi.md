...
> ModelPackage CreateScheduledPackage(ctx, body)
...
> CreateScheduledPackagesResponse CreateScheduledPackageBulk(ctx, body)
...
# **GetScheduledPackage**
> ModelPackage GetScheduledPackage(ctx, amazonOrderId, marketplaceId)
...
# **ListHandoverSlots**
> ListHandoverSlotsResponse ListHandoverSlots(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***EasyShipApiListHandoverSlotsOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EasyShipApiListHandoverSlotsOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**optional.Interface of ListHandoverSlotsRequest**](ListHandoverSlotsRequest.md)|  | 
...
> Packages UpdateScheduledPackages(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***EasyShipApiUpdateScheduledPackagesOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a EasyShipApiUpdateScheduledPackagesOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**optional.Interface of UpdateScheduledPackagesRequest**](UpdateScheduledPackagesRequest.md)|  | 
